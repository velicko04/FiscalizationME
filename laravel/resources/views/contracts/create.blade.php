                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <select name="default_type_of_invoice">
                            <option value="NONCASH" {{ old('default_type_of_invoice') == 'NONCASH' ? 'selected' : '' }}>NONCASH</option>
                            <option value="CASH" {{ old('default_type_of_invoice') == 'CASH' ? 'selected' : '' }}>CASH</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="default_payment_method">
                            <option value="ACCOUNT" {{ old('default_payment_method') == 'ACCOUNT' ? 'selected' : '' }}>ACCOUNT</option>
                            <option value="CARD" {{ old('default_payment_method') == 'CARD' ? 'selected' : '' }}>CARD</option>
                            <option value="BANKNOTE" {{ old('default_payment_method') == 'BANKNOTE' ? 'selected' : '' }}>BANKNOTE</option>
                            <option value="OTHER" {{ old('default_payment_method') == 'OTHER' ? 'selected' : '' }}>OTHER</option>
                            <option value="VOUCHER" {{ old('default_payment_method') == 'VOUCHER' ? 'selected' : '' }}>VOUCHER</option>
                            <option value="COMPENSATION" {{ old('default_payment_method') == 'COMPENSATION' ? 'selected' : '' }}>COMPENSATION</option>
                        </select>
                    </div>
                    </div>
                </div>
